...
sample_tag = unique(sample_user_tag_contact(:,2));
...
new_user_contact = ConvertPairToNewIndex(sample_user_contact,new_user_index,new_contact_index);
...
for i = 1:sample_user_cnt
    temp_tags = user_tag_cell{sample_users(i)};
